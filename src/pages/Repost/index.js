...
import { Image, Text, TextInput, View, TouchableOpacity, ToastAndroid } from 'react-native';
...
function Repost ({ route }) {
    ...
    const [mycomment, setMycomment] = useState(`#Repost de ${autor.nome}\n• ${post.descricao} •`);
    ...
    async function repostar () {
        ...
        await firebase
            ...
            .set({
                ...
                repostedFromAutorNome: autor.nome,
